...
static bool occupy_same_position(position_t queen_1, position_t queen_2)
{
...
attack_status_t can_attack(position_t queen_1, position_t queen_2)
{
    if (!(!occupy_same_position(queen_1, queen_2)
        ...
        && is_valid_position(queen_2))) return INVALID_POSITION; 
    if (queen_1.row == queen_2.row
            || queen_1.column == queen_2.column
            || is_same_diagonal(queen_1, queen_2)) return CAN_ATTACK;
