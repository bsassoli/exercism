...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    generated_power_percentage = generated_power/ theoretical_max_power
    if generated_power_percentage >= 0.80:
        return 'green'
    elif generated_power_percentage >= 0.60:
        return 'orange'
    elif generated_power_percentage >= 0.30:
        return 'red'
    else:
        return 'black'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    trigger = temperature * neutrons_produced_per_second
    if trigger < threshold * 0.9:
        return 'LOW'
    elif 0.9 * threshold > trigger or trigger < 1.10 * threshold:
        return 'NORMAL'
    else:
        return 'DANGER'
